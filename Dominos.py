...
from VoiceAssistant import talk ,  rec_audio
...
def pizza():
    ...
    driver.find_element_by_xpath('//*[@id="desktopBannerWrapped"]/div/div[3]/div[1]/button[1]').click()
    sleep(2)

    driver.find_element_by_xpath(
        '//*[@id="__next"]/div/div/div[1]/div[1]/div/div[2]/div/div[3]/div/div[1]/div[2]/div[2]/div/ul/li[1]').click()
    sleep(2)
